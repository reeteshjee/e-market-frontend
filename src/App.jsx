...
function App() {
  ...
  const [cartItems, setCartItems] = useState([
    { id: 2, name: 'Wireless Earbuds', price: 89.99, quantity: 1, image: 'https://m.media-amazon.com/images/I/61Mn590rlnL.jpg' },
    { id: 4, name: 'Coffee Maker', price: 59.99, quantity: 1, image: 'https://i5.walmartimages.com/asr/1458dfab-fe6c-4b8f-b672-40c0de6b6f31.0b69988981860c27331e02a687b073b7.jpeg?odnHeight=2000&odnWidth=2000&odnBg=FFFFFF' },
  ]);
  ...
  return (
    <>
      <Header cartCount={cartItems.length} user={user} toggleCart={toggleCart} />
